...
int row, column, is_first = 0;          // logical row, col position
...
void timeclear(int kmode) {
    int srow, scolumn, scolor, pos, w, i;
    srow = row;
    scolumn = column; //saving row and column
...
{
    int srow, scolumn, scolor, pos, w, i;
    srow = row; scolumn = column; //saving row and column
    scolor = color;
